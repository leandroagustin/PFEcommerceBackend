  ...
  constructor() {
    super(
      ...
      new Schema({
        ...
        avatar: {
          type: String,
          default: "8f474fbb3d5be1GGbab2f6629bee0jl4.png",
          required: false,
        },
        isAdmin: { type: Boolean, default: false, required: true }, //default:true para poder manipular los productos como admin
