  ...
  fetch(url)
    ...
    .then(function (data) {
      ...
      for (const pto of data) {
        ...
        aux6.innerHTML = `<a href="javascript:agregarPtoCarrito('${pto.id}')" class="btn btn-success">Agregar</a>`;
        let aux7 = document.createElement("td");
        aux7.innerHTML = `<button type="button" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#exampleModal" data-bs-id="${pto.id}">Editar</button>`;
